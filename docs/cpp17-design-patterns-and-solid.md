...
```bash
./build/fpga_to_hps_memory_mapped_hardware_driver --nominal
./build/fpga_to_hps_memory_mapped_hardware_driver --unsafe
./build/fpga_to_hps_memory_mapped_hardware_driver --offline
```
