# FPGA to HPS Memory-Mapped Hardware Driver Requirements

## Functional Requirements

| ID | Requirement | Verification |
| --- | --- | --- |
| FR-001 | The system shall expose a deterministic host-buildable runtime for FPGA to HPS Memory-Mapped Hardware Driver. | CMake/CTest smoke run. |
| FR-002 | The system shall model the project focus: Intel SoC project that maps FPGA logic into Linux user space through the HPS-to-FPGA bridge and toggles hardware registers with mmap(). | Scenario tests and documentation review. |
