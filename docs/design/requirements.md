...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for FPGA to HPS Memory-Mapped Hardware Driver. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Intel SoC project that maps FPGA logic into Linux user space through the HPS-to-FPGA bridge and toggles hardware registers with mmap(). | Scenario tests and documentation review. |
