...
ProjectProfile demoProfile() {
  return ProjectProfile{
      ...
      MetricSpec{"register_latency_us", "us", 50.0, true},
      MetricSpec{"missed_deadlines", "count", 0.0, true},
      false};
}

RuntimeSample nominalSample() {
  return RuntimeSample{1U, 22.5, 0.0, true, "host-ci-nominal"};
}

RuntimeSample unsafeSample() {
  return RuntimeSample{2U, 67.5, 2.0, true, "host-ci-limit-test"};
}

RuntimeSample offlineSample() {
  return RuntimeSample{3U, 22.5, 0.0, false, "host-ci-offline"};
}
